...
class Module(nn.Module):
    ...
    def user_hist_embed_generator(self, user_idx, item_idx):
        ...
        # attention
        user_proj_slice_scaled = self.attn_u(user_proj_slice) * user_proj_slice
        
        # representation learning
        user_rep_slice = self.rep_u(user_proj_slice_scaled)
    ...
    def item_hist_embed_generator(self, user_idx, item_idx):
        ...
        # attention
        item_proj_slice_scaled = self.attn_i(item_proj_slice) * item_proj_slice

        # representation learning
        item_rep_slice = self.rep_i(item_proj_slice_scaled)
